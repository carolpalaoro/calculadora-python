...
class Calculadora:
    def __init__(self):
        ...
        self.temas = ['dakly', 'cosmo', 'flatly', 'journal', 'litera', 'lumen', 'minty', 'pulse', 'sandstone', 'united', 'yeti', 'morph', 'simplex', 'cerculean']
    ...
    def calcular(self):
        ...
        expressao = self.display.cget("text") # Obtém a expresão do display
        expressao = expressao.replace('x', '*').replace('^', '*').replace('^', '**') # Substitui operadores para a sintaxe Python
